...
CREATE OR REPLACE FUNCTION terrapop_categorical_modis_summarization( sample_geog_level_id bigint, raster_variable_id bigint, raster_bnd bigint) 
...
DECLARE
    ...
    RETURN QUERY
	SELECT * FROM _tp_modis_categorical_summarization('terrapop_modis_boundary', raster_variable_id, raster_bnd );
